...
public class PossibleEmployeeGenerator {
	...
	private static final List<Profession> professionList = ProbabilityListGenerator.getProbabilityList(JSONEmployeeDataLoader.professionProbabilities);
	private static final List<TypeOfContract> typeOfContractList = ProbabilityListGenerator.getProbabilityList(JSONEmployeeDataLoader.typeOfContractProbabilities);
