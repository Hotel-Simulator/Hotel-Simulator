...
public class ScenarioButton extends WrapperContainer<Button> {
	...
	public ScenarioButton(HotelType hotelType) {
		this.scenarioButton = new Button(getGameSkin(), "scenario-difficulty-button");
	...
	public void createActors() {
		...
		scenarioImage = new Image(getGameSkin().getDrawable(scenarioButtonStyle.getIconPath()));
	...
	private void addSoundEvents() {
		scenarioButton.addListener(new InputListener() {
			@Override
	...
	private Label.LabelStyle createLabelStyle(String labelFont, int lineHeight) {
		Label.LabelStyle labelStyle = new Label.LabelStyle(getGameSkin().get(labelFont, Label.LabelStyle.class));
	...
	private void updateLabelStyles() {
		...
		titleStyle.font = getGameSkin().getFont(scenarioButtonStyle.getTitleLabelFont());
		titleLabel.setStyle(titleStyle);

		Label.LabelStyle descriptionStyle = descriptionLabel.getStyle();
		descriptionStyle.font = getGameSkin().getFont(scenarioButtonStyle.getDescriptionLabelFont());
