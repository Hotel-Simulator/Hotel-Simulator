...
import pl.agh.edu.ui.component.background.TimeInfinityBackground;
...
public class GameScreen implements Screen {
	...
	public GameScreen(String backgroundName, InputMultiplexer inputMultiplexer, Consumer<Float> renderConsumer, boolean timeReaction) {
		this.renderConsumer = renderConsumer;
		this.infinityBackground = timeReaction ? new TimeInfinityBackground(backgroundName) : new InfinityBackground(backgroundName, true);
	...
	public GameScreen(String backgroundName, InputMultiplexer inputMultiplexer) {
		this(backgroundName, inputMultiplexer, (value) -> {}, false);
	}
