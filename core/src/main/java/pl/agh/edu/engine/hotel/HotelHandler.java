...
public class HotelHandler {
	...
	public final BankAccount bankAccount = new BankAccount(GameDifficultyManager.getInstance().getInitialBalance(), new BankAccountDetails(new BigDecimal("0.05"), BigDecimal
			.valueOf(2)));
