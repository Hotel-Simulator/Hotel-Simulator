...
public class Engine {
    ...
    public Engine(){
        ...
        timeCommandExecutor.addCommand(
                new RepeatingTimeCommand(Frequency.EVERY_DAY,cleaningScheduler::dailyAtCheckOutTimeUpdate,LocalDateTime.of(time.getTime().toLocalDate(),hotel.getCheckOutTime())));
        timeCommandExecutor.addCommand(
